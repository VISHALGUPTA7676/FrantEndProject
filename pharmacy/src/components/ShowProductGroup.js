                ...
                <table id="supplierTab">
                    ...
                    <thead>
                        <tr id="headingSupplier" >
                            <th colSpan="2"><h5>PRODUCT GROUP LIST</h5></th>
                            <th colSpan="2" id="showList"><button><Link to="/product/addProductGroup">ADD PRODUCT GROUP</Link></button></th>
                        </tr>
                        <tr>
                            <th style={{ borderBottom: '2px solid rgb(5, 5, 5)',width:'10%',textAlign:'center'}}>Sr.</th>
                            <th style={{ borderBottom: '2px solid rgb(5, 5, 5)',width:'70%'}}>Product Group NAME</th>
                    ...
                    <tbody>
                        {
                            productGroup.map((productGroup, index) => (
                                <tr style={{height:'42px'}}>
                                    <td style={{ borderBottom: '1px solid rgb(5, 5, 5)',textAlign:'center'}}>{index + 1}</td>
                                    <td style={{ borderBottom: '1px solid rgb(5, 5, 5)'}}>{productGroup.groupName}</td>
                                    <td style={{ borderBottom: '1px solid rgb(5, 5, 5)'}}>{productGroup.status ? 'Enable' : 'Disable'}</td>
                                    <td style={{ borderBottom: '1px solid rgb(5, 5, 5)'}}><Link to={`/productGroup/editProductGroup/${productGroup.id}`} style={{textDecoration:'none'}}>Edit</Link></td>
                                </tr>
                            ))
